...
export const ModelBadge: React.FC<ModelBadgeProps> = ({ 
  ...
  const badgeStyles = cn(
    ...
    {
      'bg-orange-50 border-orange-200 text-orange-700': type === 'premium',
      'bg-blue-50 border-blue-200 text-blue-700': type === 'reasoning',
    },
    className
  );
...
export const HuggingFaceIcon: React.FC<IconProps> = ({ size = 16, className = "" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width={size} height={size} viewBox="0 0 48 48">
    <path fill="#ffd43b" d="M37.6,33.8c-2.1,2.1-5.5,2.1-7.6,0L24,27.8l-6,6c-2.1,2.1-5.5,2.1-7.6,0c-2.1-2.1-2.1-5.5,0-7.6l6-6l-6-6c-2.1-2.1-2.1-5.5,0-7.6c2.1-2.1,5.5-2.1,7.6,0l6,6l6-6c2.1-2.1,5.5-2.1,7.6,0c2.1,2.1,2.1,5.5,0,7.6l-6,6l6,6C39.7,28.3,39.7,31.7,37.6,33.8z"></path>
  </svg>
);

// Model icon selector
export const getModelIcon = (provider: string, size?: number, className?: string) => {
