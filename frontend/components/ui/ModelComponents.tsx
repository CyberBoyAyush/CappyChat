...
// Super Premium Star Icon
const SuperPremiumStarIcon: React.FC<{ size?: number; className?: string }> = ({
  size = 16,
  className = "",
}) => (
  <svg
...
export const ModelBadge: React.FC<ModelBadgeProps> = ({
  ...
  const renderIcon = () => {
    switch (type) {
      ...
      case "super-premium":
        return <SuperPremiumStarIcon size={size} />;
      default:
        return null;
    }
  };
...
export const KimiIcon: React.FC<IconProps> = ({
  size = 16,
  className = "",
}) => (
  <svg
