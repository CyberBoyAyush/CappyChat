        ...
        >
          ...
          <div className="flex flex-col items-start min-w-0">
            <div className="flex items-center gap-2">
              ...
              {tierInfo?.tier === "admin" && (
                <span className="px-1.5 py-0.5 text-xs font-medium bg-gradient-to-r from-zinc-700 to-zinc-900 dark:from-zinc-300 dark:to-zinc-100 text-white dark:text-black rounded-full">
                  ADMIN
                </span>
              )}
            </div>
