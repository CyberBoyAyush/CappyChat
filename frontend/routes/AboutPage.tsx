...
import { ArrowLeft, ExternalLink, Heart, Code, Zap, Database, Palette, Brain, Monitor } from 'lucide-react';
...
const techStack: TechStackItem[] = [
  {
    ...
    technologies: [
      { name: 'Next.js', description: 'Full-stack React framework', version: '15.3' },
      { name: 'React', description: 'UI library with concurrent features', version: '19' },
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-12">
        ...
        <div className="text-center space-y-6">
          <div className="space-y-4">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              The fastest AI chat application built with cutting-edge technology and a passion for exceptional user experiences.
            </p>
          </div>
        ...
        <section className="space-y-8">
          <div className="text-center space-y-2">
            ...
            <p className="text-muted-foreground">The passionate individuals behind AVChat</p>
          </div>
        ...
        <section className="space-y-8">
          <div className="text-center space-y-2">
            ...
            <p className="text-muted-foreground">The powerful technologies that make AVChat possible</p>
          </div>
        ...
        <section className="text-center space-y-6 py-12">
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              AVChat is open source and we welcome contributions from developers around the world. 
              Help us make AI chat faster, better, and more accessible for everyone.
            </p>
          </div>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              variant="outline"
              size="lg"
              onClick={() => window.open('https://github.com/cyberboyayush/AVChat/issues', '_blank')}
              className="flex items-center gap-2"
            >
