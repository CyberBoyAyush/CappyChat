        ...
        <div className="space-y-8">
          ...
          <div className="text-center space-y-4">
            <h1 className="text-4xl font-bold tracking-tight">
              AV<span className="text-primary">Chat</span> Changelog
            </h1>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Stay up to date with the latest features, improvements, and fixes
              in AV<span className="text-primary">Chat</span>.
            </p>
          </div>
            ...
            {CHANGELOG.map((entry, index) => {
              return (
                <div
                  key={entry.version}
                  className={`relative ${
                    index > 0 ? "border-l-2 border-muted pl-6" : ""
                  }`}
                >
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    {entry.features.map((feature, featureIndex) => {
                      ...
                      const textColor =
                        textColorMap[
                          feature.color as keyof typeof textColorMap
                        ] || textColorMap.gray;
                      const descriptionColor =
                        descriptionColorMap[
                          feature.color as keyof typeof descriptionColorMap
                        ] || descriptionColorMap.gray;
